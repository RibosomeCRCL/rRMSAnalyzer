...
1.  **Data** : a list of dataframe, containing for each sample the 5' and/or 3'-end counts provided by the user, and the calculated c-score.

2.  **Metadata** : a dataframe, containing all the information related to the samples that can be provided by the user.

3.  **RNA_names** : a dataframe, reporting the names of the RNA used in the data.
