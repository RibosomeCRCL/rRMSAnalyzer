...
When you first load your data into a RiboClass, your sites are not annotated. But maybe you want to annotate some of them.
...
We can annotate our sites with our *human_methylated* dataset :
...
This vignette has also some explanations on how to create your own sites annotation dataset with [Sites annotation].
