---
title: "Exemple code for Human analysis"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Exemple code for Human analysis}
...
```
   ...
   rRMSAnalyzer: analysis script of RiboMethSeq | Human
...
For Human analysis take "human.methylated.rda" and "human.suspected.rda"<br>
...
```{r, eval=FALSE}
report_qc(ribo = ribo, lib_col = "lib")
```
...
```{r, eval=FALSE}
report_qc(ribo = ribo_adj, lib_col = "lib", project_name = "name", comments = "./comment_QC.Rmd") 
```
...
| S28_R1.5_counts.csv   | variableC_D4_ctrlNA  | NA        | NA        | ctrl      | variableC   | ctrl      | L2  |
...
| S33_R1.5_counts.csv   | variableA_N3_ctrlctrl| NA        | NA        | NA        | variableA   | ctrl      | L2  |
| S34_R1.5_counts.csv   | variableC_D1_ctrlNA  | NA        | NA        | ctrl      | variableC   | ctrl      | L2  |
| S35_R1.5_counts.csv   | variableA_N1_P2      | P2        | NA        | NA        | variableA   | P2        | L2  |
| S36_R1.5_counts.csv   | variableA_N2_ctrlctrl| NA        | NA        | NA        | variableA   | ctrl      | L2  |
| S37_R1.5_counts.csv   | variableC_D2_ctrlNA  | NA        | NA        | ctrl      | variableC   | ctrl      | L2  |
| S38_R1.5_counts.csv   | variableA_N2_P2      | P2        | NA        | NA        | variableA   | P2        | L2  |
| S39_R1.5_counts.csv   | variableC_D1_P2      | NA        | NA        | P2        | variableC   | P2        | L2  |
| S40_R1.5_counts.csv   | variableB_N1_ctrlNA  | ctrl      | NA        | NA        | variableB   | ctrl      | L2  |
| S41_R1.5_counts.csv   | variableA_N1_P1      | P1        | NA        | NA        | variableA   | P1        | L2  |
| S42_R1.5_counts.csv   | variableA_N1_ctrlctrl| NA        | NA        | NA        | variableA   | ctrl      | L2  |
| S43_R1.5_counts.csv   | variableC_D3_P2      | NA        | NA        | P2        | variableC   | P2        | L2  |
| S44_R1.5_counts.csv   | variableB_N3_ctrlNA  | ctrl      | NA        | NA        | variableB   | ctrl      | L2  |
...
```{r, eval=FALSE}
report_2ome_sites(ribo = ribo_adj_annot_variableA,condition_col = "variableA", project_name = "name", comments = "./comment_2ome_variableA.Rmd") 
```
...
```{r, eval=FALSE}
report_diff_sites(ribo = ribo_adj_annot_variableA, condition_col = "variableA", project_name = "name", comparisons = comparisons, comments = "./comment_diff_site_variableA.Rmd") 
```
...
```{r, eval=FALSE}
report_2ome_sites(ribo = ribo_adj_annot_variableB,condition_col = "variableB", project_name = "name", comments = "./comment_2ome_variableB.Rmd") 
```

##  Analysis of rRNAs 2'Ome level differences

```{r, eval=FALSE}
report_diff_sites(ribo = ribo_adj_annot_variableB, condition_col = "variableB", project_name = "name", comparisons = comparisons, comments = "./comment_diff_site_variableB.Rmd") 
```
...
```{r, eval=FALSE}
report_2ome_sites(ribo = ribo_adj_annot_variableC, condition_col = "variableC", project_name = "name", comments = "./comment_2ome_variableC.Rmd") 
```

##  Analysis of rRNAs 2'Ome level differences

```{r, eval=FALSE}
report_diff_sites(ribo = ribo_adj_annot_variableC, condition_col = "variableC", project_name = "name", comparisons = comparisons, comments = "./comment_diff_site_variableC.Rmd") 
```
