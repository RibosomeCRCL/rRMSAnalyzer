...
> **Note**
> We have also developed a [dedicated Nextflow pipeline]() to process the data from sequencing output (fastq files) to useful raw data for rRMSAnalyzer (read end counts).
