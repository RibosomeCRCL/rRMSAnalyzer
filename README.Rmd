...
Adjust for batch effect, provide visualization capabilities, provide a table of annotated human rRNA sites and allow export of a table of C-scores. The package provides a semi-automated quality control report, provides analysis capabilities (i.e., unsupervised and supervised analysis, identification of sites differentially 2'Ome between conditions).
