...
row_annotation <- HeatmapAnnotation(
  outlier_level = qcdata$total_outliers,
  col = list(outlier_level = c("0" = "darkgrey", "1" = "lightsalmon", "2" = "orange", "3" = "#A91101")),
...
#créer un vecteur pour la couleur suivant le niveau d'outlier 
column_colors <- ifelse(qcdata$total_outliers > 0, "red", "black")

# Plot de la heatmap avec annotations
x <- Heatmap(
  ...
  column_names_gp = gpar(col = column_colors, fontsize = 16)
)
draw(
  x,
