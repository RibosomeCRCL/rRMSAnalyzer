...
<br>
Data aligned on: **GRCh38 (gencode annotation V46)** for human project and **mm39 (gencode version vM35)** for murine project.<br>
<br>
...
plot_rle <- rRMSAnalyzer::plot_rle(ribo_to_check,show_outlier = TRUE) + ggplot2::ggtitle("Relative Log Coverage")
...
rRMSAnalyzer::plot_heatmap_annotated(ribo, qcdata)
```
