...
qcdata <- cbind(qcdata,median_coverange=medcov[rownames(qcdata)])
qcdata$coverage_quality <- "ok"
qcdata$coverage_quality[qcdata$median_coverange < 100] <- "warning"
...
median <- as.vector(plot_rle$plot_env$rle_grouped$median)
